...
<div class="cursor-pointer transform hover:scale-105 transition" x-data="{ open: false }" @click.outside="open = false" draggable="false">
    <a href="{{ $link }}">
...
<!--
bg-bgColorSecondary bg-opacity-90
-->
